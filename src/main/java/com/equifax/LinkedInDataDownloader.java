...
/*
 * ResumeBuilder. Builds a resume from your LinkedIn profile using JasperSoft's tools. Copyright (C)
 * 2013, Frank Hassanabad This program is free software: you can redistribute it and/or modify it
 ...
 * <pre>
 * Enter your LinkedIn API Key: 755ajzhbsi2qr9
 * >> (enter your LinkedIn API key)
 *
 * Enter your LinkedIn API Secret Key: v9WnYhhDIyQS661W
...
public class LinkedInDataDownloader
{
     ...
     */
    private static final String resumeFields = "(id,first-name,last-name,positions,skills,picture-url,site-standard-profile-request,"
        + "educations,phone-numbers,main-address,email-address,headline,summary,interests,"
        + "public-profile-url)";

    /** The REST API for getting the profile data */
    private static final String PROFILE_RESOURCE_URL = "http://api.linkedin.com/v1/people/~:"
        + resumeFields;
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        //Enter your LinkedIn API Key
        String apiKey = "755ajzhbsi2qr9";
        System.out.println("Your LinkedIn API Key: " + apiKey);
        //Enter your LinkedIn Secret Key

        String apiSecretKey = "v9WnYhhDIyQS661W";
        System.out.println("Your LinkedIn API Secret Key: " + apiSecretKey);
